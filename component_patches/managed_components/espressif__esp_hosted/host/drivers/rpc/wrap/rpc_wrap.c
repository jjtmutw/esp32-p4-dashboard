...
int rpc_wifi_init(const wifi_init_config_t *arg)
{
	...
	wifi_init_config_t compat_cfg;
	g_h.funcs->_h_memcpy(&compat_cfg, (void*)arg, sizeof(wifi_init_config_t));
	compat_cfg.static_rx_buf_num = 10;
	compat_cfg.dynamic_rx_buf_num = 32;
	compat_cfg.tx_buf_type = 1;
	compat_cfg.static_tx_buf_num = 0;
	compat_cfg.dynamic_tx_buf_num = 32;
	compat_cfg.rx_mgmt_buf_type = 1;
	compat_cfg.rx_mgmt_buf_num = 5;
	compat_cfg.cache_tx_buf_num = 0;
	compat_cfg.csi_enable = 0;
	compat_cfg.ampdu_rx_enable = 1;
	compat_cfg.ampdu_tx_enable = 1;
	compat_cfg.amsdu_tx_enable = 0;
	compat_cfg.nvs_enable = 1;
	compat_cfg.nano_enable = 0;
	compat_cfg.rx_ba_win = 6;
	compat_cfg.wifi_task_core_id = 0;
	compat_cfg.beacon_max_len = 752;
	compat_cfg.mgmt_sbuf_num = 32;
	compat_cfg.feature_caps = 0;
	compat_cfg.sta_disconnected_pm = true;
	compat_cfg.espnow_max_encrypt_num = 0;
	compat_cfg.tx_hetb_queue_num = 0;
	compat_cfg.dump_hesigb_enable = false;

	g_h.funcs->_h_memcpy(&req->u.wifi_init_config, &compat_cfg, sizeof(wifi_init_config_t));
